...
module.exports = class extends Command {
    constructor(...args) {
        super(...args, {
            aliases: ['Server', 'Serverinfo', 'Guildinfo', 'Guild', 'Info']
        });
    }
    ...
    async run(message, args = []) {
        ...
        const embed = new MessageEmbed()
			...
			.addField('Server Roles', this.client.utils.displayRoles(roles))
			.setTimestamp();
		message.channel.send(embed).then(() => {
			super.report(message.author.username, "server stats and information!");
		})
    }
}