...
/**
 * @typedef {{"id": string, "name": ?string, "version": string, "description": ?string, "author": ?string, "entryPath": string, "config": ?Object, "type": ("executable" | "dependency" | "other" | "selectable"), "manPages": ?Array<string>}} manifest
 */
